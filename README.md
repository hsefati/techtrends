...
The web application is written using the [Python Flask](https://flask.palletsprojects.com/en/stable/) framework. It uses [SQLite](https://docs.python.org/3/library/sqlite3.html), a lightweight disk-based database to store the submitted articles.
